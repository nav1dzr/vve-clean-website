...
export default function ErrorScreen({ title = "Couldn't verify your session", message, onRetry }: ErrorScreenProps) {
  return (
    <div className="flex min-h-screen flex-col items-center justify-center gap-4 bg-silver-100 px-6 text-center">
      <h1 className="font-semibold text-xl text-navy-950">{title}</h1>

...
export function toInvoiceDetail(row) {
  return {
    ...
    revisedFromInvoiceId: row.revised_from_invoice_id || null,
    revisedFromInvoiceNumber: row.revised_from_invoice_number || null,
    revisedFromIssueDate: row.revised_from_issue_date || null,
    supersededByInvoiceId: row.superseded_by_invoice_id || null,

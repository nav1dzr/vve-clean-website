...
export function renderBookingEmail({ payload, heading, intro, initial, business, link, depositDue, paymentInstructions }) {
  ...
  const greeting = business ? 'VVE Clean booking update' : `Hello ${fullName},`;

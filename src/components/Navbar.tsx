...
const navLinks = [
  ...
  // Dedicated /contact page (not the homepage #contact anchor) — matches
  // the Footer's Contact link, so the label means the same thing everywhere.
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 lg:h-20">
          ...
          <div className="hidden lg:flex items-center gap-3">
            <a href={CONTACT_PHONE_TEL} onClick={() => trackPhoneClick('navbar')}
      ...
      <div id="mobile-nav-menu" className={`lg:hidden transition-all duration-300 overflow-hidden ${menuOpen ? 'max-h-screen opacity-100' : 'max-h-0 opacity-0'}`}
        ...
        <div className="px-4 py-6 space-y-4">
          ...
          <a href={CONTACT_PHONE_TEL} onClick={() => setMenuOpen(false)}

      ...
      <div className="max-w-5xl mx-auto px-4 h-16 flex items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2 flex-shrink-0">
          ...
          <a href={LEAFLET_WA} target="_blank" rel="noopener noreferrer"
            className="md:hidden flex items-center gap-1.5 btn-whatsapp font-semibold text-xs px-3 py-2 rounded-full transition-colors min-h-[36px]"
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center mb-10">
            ...
            <a href={waLink} target="_blank" rel="noopener noreferrer"
              className="btn-whatsapp inline-flex items-center justify-center gap-2 px-7 py-4 rounded-full font-bold text-base transition-all hover:opacity-90">
